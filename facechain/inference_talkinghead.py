...
class SadTalker():
    ...
    def __call__(self, *args, **kwargs) -> Any:
        ...
        inference = pipeline_dk('talking-head', model='wwd123/sadtalker', model_revision='v1.0.0')
