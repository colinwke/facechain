...
from facechain_animate.magicanimate.models.appearance_encoder import AppearanceEncoderModel
from facechain_animate.magicanimate.models.mutual_self_attention import ReferenceAttentionControl
from facechain_animate.magicanimate.pipelines.pipeline_animation import AnimationPipeline
from facechain_animate.magicanimate.utils.util import save_videos_grid
from facechain_animate.magicanimate.utils.dist_tools import distributed_init
from accelerate.utils import set_seed

from facechain_animate.magicanimate.utils.videoreader import VideoReader
...
def main(args):
    ...
    *_, func_args = inspect.getargvalues(inspect.currentframe())
    ...
    appearance_encoder = AppearanceEncoderModel.from_pretrained(magicanimate_model_dir, subfolder="appearance_encoder").cuda()
    ...
    for idx, (source_image, test_video, random_seed, size, step) in tqdm(
        ...
        if args.rank == 0:
            ...
            source_name = os.path.basename(source_image).split(".")[0]
