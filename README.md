...
Our work [FaceChain-ImagineID](https://arxiv.org/abs/2403.01901) and FaceChain-SuDe got accepted to CVPR 2024 !
...
```shell
PYTHONPATH=. sh train_lora.sh "ly261666/cv_portrait_model" "v2.0" "film/film" "./data/cache_req/a_spec_reqid/input_img" "./data/cache_req/a_spec_reqid/output_processed" "./data/cache_req/a_spec_reqid/output_train"
```
...
./data/cache_req/a_spec_reqid/input_img: This parameter needs to be replaced with the actual value. It means a local file directory that contains the original photos used for training and generation
./data/cache_req/a_spec_reqid/output_processed: The folder of the processed images after preprocessing, this parameter needs to be passed the same value in inference, no need to be changed
./data/cache_req/a_spec_reqid/output_train: The folder where the model weights stored after training, no need to be changed
```
...
processed_dir = './data/cache_req/a_spec_reqid/output_processed'
...
train_output_dir = './data/cache_req/a_spec_reqid/output_train'
# Specify a folder to save the generated images, this parameter can be modified as needed
output_dir = './data/cache_req/a_spec_reqid/output_generated'
